<template>
    ...
    <section class="carousel rounded-lg">
            ...
            <div class="item">
                ...
                <div class="content">
                    ...
                    <p class="description">
                        ...
                        Ipsum facere ipsa blanditiis quidem dignissimos enim
                        quam corrupti praesentium ipsam assumenda?
                    </p>
                    <div class="more">
        ...
        <div class="arrows">
            <button id="prev"><v-icon>mdi-arrow-left</v-icon></button>
            <button id="next"><v-icon>mdi-arrow-right</v-icon></button>
        </div>
