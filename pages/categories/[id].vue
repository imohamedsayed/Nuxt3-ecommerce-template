        ...
        <v-container>
            <div class="products-list mt-10">
                <v-row class="align-center">
                    <v-col cols="12" md="2">
                        <v-select label="Sort" variant="plain" :items="sortOptions"
                            class="bg-background font-weight-bold" v-model="sort"
                            @update:model-value="fetchData"></v-select>
                    </v-col>
                    <v-col cols="12" md="4">
                        <v-chip-group v-model="sort2" selected-class="text-primary" color="primary" mandatory
                            ...
                            <v-chip value="desc">
                                <IconsDescending /> <v-tooltip activator="parent">Descending</v-tooltip>
                            </v-chip>
                        </v-chip-group>
                    </v-col>
                </v-row>
                ...
                <div class="products">
                    ...
                    <v-pagination class="mt-15" dir="ltr" v-model="page" :length="pagination?.last_page || 10"
                        color="primary" @update:model-value="fetchData"></v-pagination>
                </div>
            </div>
        </v-container>
    </div>
